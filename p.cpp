...
{
    system("clear");  // Clear the console screen
    cout << "ARINOL is opening...";  // Display opening message
...
{
    system("clear");  // Clear the console screen
    cout << "ARINOL is shutting down...";  // Display shutdown message
    char chars[] = {'\\', '|', '/', '-'};  // Define animation characters
    for (int i = 0; i < 20; i++)  // Loop for animation frames
    {
        cout << "\t[" << chars[i % 4] << "]";  // Display animation frame
...
void Destroy_ALL_PROCESS(){
    ...
    for (int i = 0; i < cores; i++)
    {
        ...
        {
            ptr[i].processs_id = 0;
            int signal = SIGKILL; // use SIGKILL to forcefully terminate the process
    ...
    for (int i = 0; i < SIZE_OF_QUEUE; i++)
    {
        ...
        if (processQueue[i].processs_id != 0)
        {
            processQueue[i].processs_id = 0;
            int signal = SIGKILL; // use SIGKILL to forcefully terminate the process
            int result = kill(pid, signal);
        }
    }
            ...
            case 1:
                {
                    int ch=0;
                        ...
                        do {
                            ...
                            cout << "1. LUDO GAME " << endl;
                            cout << "2. NOTEPAD " << endl;
                            cout << "3. CALCULATOR " << endl;
                            cout << "4. AGE CALCULATOR " << endl;
                            cout << "5. COPY " << endl;
                            cout << "6. CREATE " << endl;
                            cout << "7. MOVE " << endl;
                            cout << "8. LETTER COUNT " << endl;
                            cout << "9. NUMBER GUESS GAME " << endl;
                            cout << "10. TEMPRATURE MONITOR " << endl;
                            ...
                            switch (ch) {
                                ...
                                case 1:
                                {
                                    create_process("game.cpp",100,200);
                                    break;
                                }
                                case 2:
                                {
                                ...
                                case 3:
                                {
                                    create_process("calculator.cpp",15,30);
                                    break;
                                }
                                case 4:
                                {
                                    create_process("agecal.cpp",20,30);

                                    break;
                                }
                                 case 5:
                                {
                                    create_process("copy.cpp",5,10);

                                    break;
                                }
                                 case 6:
                                {
                                    create_process("create.cpp",15,30);

                                    break;
                                }
                                 case 7:
                                {
                                    create_process("move.cpp",5,10);

                                    break;
                                }
                                 case 8:
                                {
                                    create_process("lettercount.cpp",15,20);

                                    break;
                                }
                                 case 9:
                                {
                                    create_process("numguess.cpp",30,40);

                                    break;
                                }
                                 case 10:
                                {
                                    create_process("tempcal.cpp",25,35);
            ...
            case 2:
                {
                    ...
                    do
                    {
                                cout<<"press 0 to exit kernel mode : \n";
                                cout<<"press 1 to Destroy all processes : \n";
                                cout<<"press 2 to Delete  a process from ready queue : \n";
                                cout<<"press 3 to DISPLAY THE QUEUE : \n";
                                cout<<"press 4 to SEE THE ACTIVE PROCESS : \n";
